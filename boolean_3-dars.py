...
#  16-misol.
a = 26;             print(a%2 ==0 and a > 9)

#  17-misol.
a = 155;            print(a%2 != 0 and a > 99)
...
#  35-misol.
x1, x2, y1, y2 = 2,3,4,5;       print("Shox=", abs(x2-x1) < 2 and abs(y2-y1) < 2 and (abs(x1-x2) + abs(y2-y1)) <3 )
...
#  39-misol.
x1, x2, y1, y2 = 2,3,4,5;       print("Tura=", abs(x2-x1)==0 or abs(y2-y1)==0 )

#  40-misol.
x1, x2, y1, y2 = 2,3,4,5;       print("Ot=", (abs(x2-x1)==1 and abs(y2-y1)==2) or (abs(x2-x1)==2 and abs(y2-y1)==1))
